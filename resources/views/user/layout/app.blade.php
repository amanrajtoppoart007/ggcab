    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="{{ url('/about') }}">About GG</a>
                </li>
                <li>
                    <a href="{{ url('/help') }}">Help</a>
                </li>
                <li>
                    <a href="{{ url('/pp') }}">Privacy Policy</a>
                </li>
                <li>
                ...
                <li>
                    <a href="https://play.google.com/store/apps/details?id=com.gogreencab.user"><img src="{{ asset('/asset/img/playstore-white.png') }}"></a>
                </li>
            </ul>
        </nav>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li @if(Request::url() == url('/career')) class="active" @endif>
                                    <a href="{{url('/career')}}">Career</a>
                                </li>
                        ...
                        <div class="row no-margin">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    ...
                                    <li><a href="{{url('about')}}">About GG</a></li>
                                    <li><a href="{{url('cities')}}">Cities</a></li>
                                    <li><a href="{{url('fareestimate')}}">Fare Estimate</a></li>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <ul class="app">
                                    ...
                                    <li>
                                        <a href="https://play.google.com/store/apps/details?id=com.gogreencab.user">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">                        
                                <h5 style="font-size:24px">Connect us</h5>
                                <ul class="social">
                                    <li><a href="https://m.facebook.com/ggcabs.in"><i style="font-size:40px" class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://mobile.twitter.com/gg_cab"><i style="font-size:40px" class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/gogreencabs/"><i style="font-size:40px" class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UC3wBpp5_06a3bLM-fMWaPcw"><i style="font-size:40px" class="fa fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
