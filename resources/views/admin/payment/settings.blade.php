    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <form action="{{route('admin.settings.payment.store')}}" method="POST">
		        ...
		        <div class="form-group row">
                            <label for="evening_charge_percentage" class="col-xs-4 col-form-label">Evening Charge Percentage</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                                    value="{{ Setting::get('evening_charge_percentage', '0') }}"
                                    id="evening_charge_percentage"
                                    name="evening_charge_percentage"
                                    min="0"
                                    max="100"
                                    placeholder="Evening Charge Percentage">
                            </div>
                        </div>
                        <div class="form-group row">
