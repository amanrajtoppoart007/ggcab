            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dt class="col-sm-4"> Ride is cancelled by:</dt>
                       <dd class="col-sm-8">
				{{ $request->cancelled_by }}
                        ...
                        <dd class="col-sm-8">
                            @if($request->started_at != "0000-00-00 00:00:00" && $request->finished_at != null)
                        ...
                        <dd class="col-sm-8">
                            @if($request->finished_at != "0000-00-00 00:00:00" && $request->finished_at != null) 
