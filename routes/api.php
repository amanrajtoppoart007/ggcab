...
Route::post('money/add/wallet',  'WalletController@addMoney');
Route::get('wallet/{user_id}', 'WalletController@userWallet');
Route::post('money/deduct/wallet', 'WalletController@deductMoney');
Route::post('userrequest/card/payment', 'WalletController@payment');

Route::post('webhook', 'WalletController@handleWebhook');

Route::get('test-payment', 'WalletController@paymentForm');

Route::get('test-payment1', 'WalletController@submitPayment')->name('test-payment');
