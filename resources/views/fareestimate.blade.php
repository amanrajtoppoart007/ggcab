...
<div class="row gray-section no-margin full-section">
 ...
 <h2>Rate Card</h2>
            <div class="title-divider"></div>
            <p>Select the Rate Card option available in the Gg cab app menu to check the fares for Gg
cab rides in different cities.<br>
1. Checking the Fare for a Cab Category<br>
Just double-tap or press and hold a cab category icon (Ex: Micro, Mini or Prime Sedan) on
the Gg cab app to know the per kilometer charge of that cab category.<br>
2. Checking Total Fare<br>
Alternately, you can also enter the drop location and choose the cab category to check the
estimated Total Fare for your ride.<br> <br> 
Note- The estimated total fare for your ride may vary due to traffic conditions or any
variation in distance traveled.</p>
