...
class AdminController extends Controller
{
    ...
    public function map_ajax()
    {
        try {
            ...
            $All = array_merge($Users->toArray(), $Providers->toArray());
    ...
    public function settings_payment_store(Request $request)
    {
        ...
        Setting::set('evening_charge_percentage', $request->evening_charge_percentage);
        Setting::save();
    ...
    public function statement($type = 'individual'){
        ...
        try{
            ...
            if($type == 'today'){
                ...
                $rides->whereMonth('created_at', '>=', Carbon::now()->month);
                $cancel_rides->whereMonth('created_at', '>=', Carbon::now()->month);
                $revenue->whereMonth('created_at', '>=', Carbon::now()->month);
